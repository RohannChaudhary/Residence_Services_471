...
const navigation = [
  { name: "Dashboard", href: "http://localhost:3000/admindashboard", current: false },
  { name: "Complains", href: "http://localhost:3000/admindashboard/complains", current: true },
];
...
export default function AdminComplains() {
  return (
      ...
      */}
      ...
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          <h1 className="text-xl font-semibold text-gray-900">Outstanding Student Complains</h1>
          <p className="mt-2 text-sm text-gray-700">
            A list of all the active student complains including their UCID, email address, and their complaint.
          </p>
        </div>
    ...
    <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          <h1 className="text-xl font-semibold text-gray-900">Resolved Student Complains</h1>
          <p className="mt-2 text-sm text-gray-700">
            A list of all the past student complains including their UCID, email address, and their complaint.
          </p>
        </div>
      </div>
      <div className="mt-8 flex flex-col">
